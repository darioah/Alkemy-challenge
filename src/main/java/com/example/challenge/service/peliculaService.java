 ...
 * Deberá permitir buscar por título, y filtrar por género. Además, permitir
 * ordenar los
 * resultados por fecha de creación de forma ascendiente o descendiente.
 * El término de búsqueda, filtro u ordenación se deberán especificar como
 * parámetros de
 * query:
 * ● /movies?name=nombre
 ...
 * ● GET /movies
 * Recordar que si ningún filtro es enviado, se deben devolver todas las
 * entidades
 */
@Service
public class peliculaService {
    ...
    // ○ Al crear una Película, crearla con sus personajes asociados
    @Transactional
    public Peliculas save(String Imagen, String Título, String Fechadecreación, String Calificación,
    ...
    public Peliculas update(String id, String Imagen, String Título, String Fechadecreación, String Calificación,
            String Personajesasociados) {
    ...
    public Peliculas getById(String id) {
        return peliculasRepo.getById(id);
    }

    public List<Peliculas> listarPeliculaPorNombre(String titulo) throws Exception {
        List<Peliculas> movies = peliculasRepo.peliculaPorNombre(titulo);
        return movies;
    }

    public List<Peliculas> listarPeliculaPorGenero(Long generoID) throws Exception {
        List<Peliculas> movies = peliculasRepo.peliculaPorGenero(generoID);
        return movies;
    }

    public List<Peliculas> listarPeliculaAsc() throws Exception {
        List<Peliculas> movies = peliculasRepo.peliculaOrdenAsc();
        return movies;
    }

    public List<Peliculas> listarPeliculaDesc() throws Exception {
        List<Peliculas> movies = peliculasRepo.peliculaOrdenDesc();
        return movies;
    }
